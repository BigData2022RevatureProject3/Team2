...
class ProducerTest extends flatspec.AnyFlatSpec with matchers.must.Matchers {
  ...
  "negative_price()" should "Return Negative Inverse Of N" in {
    val startArray = Array[String]("800050", "Kimchi", "Food", "5485.99", "68", "Payment gateway unreachable", "Frankfurt", "Germany", "68", "UPI", "N")
    assert(negative_price(startArray)(3) == "-5485.99")
  }

  "false_failure()" should "Return False Error Or Null" in {
